...
import { createSchedule, deletedSchedule, getAllSchedules, getMySchedules, getSchedulesDetail, updateSchedule } from '../controllers/Schedule.controllers.js';
...
routeSchedule.put("/:id", verifytoken, authorize("admin"), updateSchedule);
